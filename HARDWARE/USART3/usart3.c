...
{ 	NVIC_InitTypeDef NVIC_InitStructure;
 ...
 //	USART2->BRR=(pclk1*1000000)/(bound);// 波特率设置	 
	...
	USART_DMACmd(UART5,USART_DMAReq_Tx,ENABLE);  	//使能串口3的DMA发送
	UART_DMA_Config(DMA2_Channel2,(u32)&UART5->DR,(u32)UART5_TX_BUF);//DMA2通道2,外设为串口3,存储器为UART5_TX_BUF 
...
//	UART_DMA_Enable(DMA1_Channel2,strlen((const char*)UART5_TX_BUF)); 	//通过dma发送出去
