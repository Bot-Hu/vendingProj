...
void Show_Font_Color(u16 x,u16 y,u8 *font,u8 size,u8 mode,u16 color);					//在指定位置显示一个汉字带颜色
void Show_Str_Color(u16 x,u16 y,u16 width,u16 height,u8*str,u8 size,u8 mode,u16 color);	//在指定位置显示一个字符串带颜色 
